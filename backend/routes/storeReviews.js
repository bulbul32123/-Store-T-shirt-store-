...
// PUT  /api/reviews/:id          (owner only — resets status to pending)
...
router.get('/reviews/:id', protect, admin,reviewController.getReviewById); // add getReviewById to the destructured import at top

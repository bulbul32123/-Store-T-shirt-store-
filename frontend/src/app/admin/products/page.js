        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage and monitor your online store items</p>
                </div>
                <Link
                    href="/admin/products/new"
                    className="bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 flex items-center shadow-sm"
                >
            ...
            {/* NEW: Interactive Filtering Toolbar built for Name, Price, and Stock */}
            <div className="bg-white p-4 rounded-lg shadow border border-gray-150 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
                ...
                <div className="relative">
                    <label className="block text-xs font-medium text-gray-600 uppercase mb-1">Search Name</label>
                    <div className="relative">
            ...
            {loading && products.length === 0 ? (
                ...
                <div className="bg-white rounded-lg shadow border border-gray-200 text-center py-12 text-gray-500">
                    <p className="text-lg font-medium">No products found matching filters</p>
                </div>
            ) : (
                <ProductsTable
                    products={products}

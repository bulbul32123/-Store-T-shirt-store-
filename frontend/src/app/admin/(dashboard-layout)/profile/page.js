                        ...
                        <div className="bg-gray-50 p-6 border-r border-gray-200">
                            <div className="flex items-center mb-6">
                                {user.profilePicture?.url ? (
                                    ...
                                    <div className="h-12 w-12 rounded-full bg-[#CAEF96] flex items-center justify-center text-black text-lg font-bold mr-3">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mt-6">
                    <button
                        type="submit"
                        disabled={loading}
                        className={`px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-black ${loading ? 'bg-[#CAEF96]/80' : 'bg-[#CAEF96] hover:bg-[#CAEF96]/80'

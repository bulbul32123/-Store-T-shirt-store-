        ...
        <div className="bg-white border rounded-lg overflow-hidden">
          <div className="md:flex">
            <div className="bg-gray-50 p-6 border-r border-gray-200">
              <div className="flex items-center mb-6">
                {user.profilePicture?.url ? (
                  ...
                  <div className="h-12 w-12 rounded-full bg-[#ffb800] flex items-center justify-center text-black text-lg font-bold mr-3">
            ...
            <div className="flex-1 p-6">
              ...
              {activeTab === "security" && (
                <SecurityTab user={user} updateProfile={updateProfile} />
              )}
              {activeTab === "addresses" && (
                <AddressesTab user={user} updateProfile={updateProfile} />
              )}
            </div>
          </div>
        </div>

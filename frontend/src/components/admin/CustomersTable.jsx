...
function SegmentPip({ segment }) {
  return (
    <span
      className={`inline-flex items-center px-1.5 py-0 rounded text-[10px] font-bold
...
function SkeletonRow() {
  return (
    <tr className="border-b border-gray-50 animate-pulse">
      ...
      <td className="px-4 py-3 text-center">
        <div className="h-6 w-6 bg-gray-100 rounded-lg mx-auto" />
      </td>
    </tr>
  );
}
  ...
  return (
    <tr className="hover:bg-indigo-50/30 transition-colors group">
      <td className="px-4 py-3 pl-4">
        <div className="flex items-center gap-3">
          <UserAvatar user={customer} size="h-9 w-9" textSize="text-xs" />

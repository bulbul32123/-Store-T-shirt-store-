...
function SkeletonRow() {
    return (
        <tr className="animate-pulse">
            ...
            <td className="px-4 py-3"><div className="flex gap-2"><div className="h-7 w-16 bg-gray-200 rounded-lg" /><div className="h-7 w-16 bg-gray-200 rounded-lg" /></div></td>
        </tr>
    );
}
...
function RowActions({ review, onApprove, onReject, onDelete, onViewDetail }) {
    return (
        <div className="flex items-center gap-1">
            <button
                onClick={(e) => { e.stopPropagation(); onViewDetail(review); }}
                title="View detail"
    ...
    return (
        <div
            className={`bg-white rounded-xl border transition-colors cursor-pointer ${
                selected ? 'border-indigo-300 bg-indigo-50/30' : 'border-gray-100 hover:border-gray-200'
            }`}
        ...
        >
            <div className="p-4">
                ...
                <div className="flex items-start gap-3 mb-3">
                    ...
                    />
                    {thumb ? (
                        <img src={thumb} alt={review.product?.name} className="h-10 w-10 rounded-lg object-cover flex-shrink-0" />
                    ) : (
                                ...
                                return (
                                    <tr
                                        ...
                                        className={`cursor-pointer transition-colors ${
                                            selectedIds.has(review._id) ? 'bg-indigo-50/40' : 'hover:bg-gray-50/60'
                                        }`}
                                        onClick={() => onViewDetail(review)}
                                    >
                                        {/* Checkbox */}

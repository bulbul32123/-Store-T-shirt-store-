...
export default function ReviewFiltersBar({
    ...
    const hasActiveFilters = rating || search || dateFrom || dateTo || sort !== 'newest';
    ...
    return (
        <div className="bg-white rounded-xl border border-gray-100 p-4 space-y-3">
            <div className="flex flex-wrap gap-3 items-center">
                ...
                {hasActiveFilters && (
                    <button onClick={onReset} className="flex items-center gap-1.5 px-3 py-2 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                        <FiX size={13} /> Reset
                    </button>
                )}
            </div>

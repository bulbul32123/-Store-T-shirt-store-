      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end space-x-3">
          ...
          <button
            type="submit"
            disabled={isSaving}
            className={`px-4 py-2 border border-transparent rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center gap-2 ${isSaving ? "opacity-70 cursor-not-allowed" : ""}`}
          >
            {isSaving && (

...
function StatBox({ icon: Icon, label, value, colorCls }) {
  return (
    <div
      className={`flex-1 flex flex-col items-center justify-center p-3 rounded-xl ${colorCls}`}
    >
      <Icon className="h-4 w-4 mb-1 opacity-60" />
      <p className="text-[10px] text-current opacity-60 uppercase tracking-wide font-semibold">
        {label}
      </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <ul className="mt-2 space-y-1">
                        ...
                        {customer.phone && (
                          <ContactItem icon={Phone} text={customer.phone} />
                        )}
                  ...
                  {loadingDet ? (
                    <div className="flex gap-3 animate-pulse">
                      {[1, 2, 3].map((i) => (
                        <div
                          key={i}
                          className="flex-1 h-20 bg-gray-100 rounded-xl"
                        />
                      ))}
                    </div>
                  ) : (

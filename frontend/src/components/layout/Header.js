  ...
  return (
    <div className=" bg-[#f7f5f5]">
      <div className="py-2 2xl:py-3 flex justify-between padding-sm max-md:hidden mx-auto h-full w-full  2xl:max-w-[1500px] pl-5 pr-5 md:pl-10 md:pr-10">
        <h5 className="2xl:text-lg 2xl:font-bold">
          ...
          {isLoading ? (
            ...
            <>
              <li className="list-none flex pt-1 justify-center items-center">
                ...
                <Link
                  className="md:text-xs 2xl:text-lg 2xl:font-bold md:font-medium"
                  href="/auth/register"
                >
                  Sign Up
                </Link>
              ...
              <li className="list-none flex pt-1 justify-center items-center">
                ...
                <Link
                  className="text-xs 2xl:text-lg 2xl:font-bold md:font-medium"
                  href="/auth/login"
                >
                  Log In
                </Link>

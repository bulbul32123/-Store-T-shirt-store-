    ...
    return (
      <div className="relative">
        <Link
          ...
          className="relative block hover:text-gray-500 transition-colors max-md:p-3 max-md:rounded-full max-md:bg-primary max-md:hover:bg-black max-md:text-white max-md:hover:text-white transitions"
        >
          <FavouriteIcon />
          {itemCount > 0 && (

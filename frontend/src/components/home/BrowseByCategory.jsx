...
const categories = [
  { name: "Sneakers", image: "/cat2.jpg" },
  { name: "Pants", image: "/Cate_2.webp" },
  { name: "Sunglasses", image: "/Cate_3.webp" },
  { name: "T-shirts", image: "/cat1.avif" },
  { name: "Shoes", image: "/Cate_4.webp" },
  { name: "Bags", image: "/Cate_5.webp" },
];

const BrowseByCategory = ({ isLoading = false }) => {
  return (
    <section className="max-w-6xl mx-auto pb-16 pt-9">
      <h2 className="text-3xl font-bold mb-6">Browse by Categories</h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px]">
        {isLoading
          ? // Render layout-accurate skeletons matching structural span logic
